...
export default function PlayerCard({ player, onSelect }: PlayerCardProps) {
  ...
  return (
    <button
      ...
      className="group flex min-h-36 w-full flex-col items-stretch rounded-xl border border-slate-200 bg-white p-3 text-left transition-colors duration-200 hover:border-academy hover:bg-academy/5 focus:outline-none focus:ring-2 focus:ring-academy focus:ring-offset-2 motion-reduce:transition-none"
