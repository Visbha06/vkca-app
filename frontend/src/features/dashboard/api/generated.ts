...
export interface paths {
    ...
    "/api/v1/matches": {
        ...
        /**
         * List Matches
         * @description List all recorded cricket matches.
         */
        get: operations["list_matches_api_v1_matches_get"];
        put?: never;
        /**
         * Create Match
         * @description Record a cricket match.
         */
    ...
    "/api/v1/players/{player_id}/account": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
    ...
    "/api/v1/players/{player_id}/account/reassign": {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
...
export interface components {
    schemas: {
        ...
        NormalizeRosterOrderRequest: {
            /**
             * Action
             * @default normalize_roster_order
             * @constant
             */
            action: "normalize_roster_order";
            /**
        ...
        RemoveInactiveAssistantAssignmentRequest: {
            /**
             * Action
             * @default remove_inactive_assistant_assignment
             * @constant
             */
            action: "remove_inactive_assistant_assignment";
            /**
        ...
        RemoveInactivePlayerRequest: {
            /**
             * Action
             * @default remove_inactive_player
             * @constant
             */
            action: "remove_inactive_player";
            /**
...
export interface operations {
    ...
    link_player_account: {
        ...
        requestBody: {
            content: {
                "application/json": components["schemas"]["PlayerAccountLinkRequest"];
            };
        };
        responses: {
            /** @description Successful Response */
    ...
    unlink_player_account: {
        ...
        requestBody: {
            content: {
                "application/json": components["schemas"]["PlayerAccountUnlinkRequest"];
            };
        };
        responses: {
            /** @description Successful Response */
    ...
    reassign_player_account: {
        ...
        requestBody: {
            content: {
                "application/json": components["schemas"]["PlayerAccountReassignRequest"];
            };
        };
        responses: {
            /** @description Successful Response */
