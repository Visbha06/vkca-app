...
interface AssignmentCloseConfirmationProps {
  onContinueEditing: () => void
  onDiscard: () => void
}

export default function AssignmentCloseConfirmation({
  onContinueEditing,
  onDiscard,
}: AssignmentCloseConfirmationProps) {
  ...
  return (
    <div
      ...
      className="bg-white p-5 text-slate-900 sm:p-6"
    >
      <h2 id="assignment-unsaved-title" className="text-xl font-bold">
        You have unsaved changes
      </h2>
      <p className="mt-2 max-w-prose text-sm leading-6 text-slate-700">
        Discarding will remove the assignment changes you made.
      </p>
