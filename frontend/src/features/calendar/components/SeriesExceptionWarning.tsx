...
export default function SeriesExceptionWarning({
  ...
  useEffect(() => {
    if (!isSubmitting) cancelButtonRef.current?.focus()
  }, [isSubmitting])
  ...
  return (
    <div className="bg-white p-5 text-slate-900 sm:p-6">
      ...
      <p id="series-exception-warning-description" className="mt-2 max-w-prose text-sm leading-6 text-slate-700">
