...
export default function BusinessAuditLogPage() {
  ...
  return <section className="mx-auto w-full min-w-0 max-w-7xl overflow-x-hidden">
    ...
    <p role="status" aria-atomic="true" aria-live="polite" className="my-5 text-sm font-semibold text-slate-700">{audit.isFetching ? 'Updating academy activity…' : eventCount === 1 ? '1 event found' : `${eventCount} events found`}</p>
